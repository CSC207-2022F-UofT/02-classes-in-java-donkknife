...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings as arguments and concatenates them to set the name.
     *
     * @param name1 the first part of the name for this Silly instance's name.
     * @param name2 the second part of the name for this Silly instance's name.
     */
